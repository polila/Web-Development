const context = {
  ...
  contact: [
    {
      top:"Let's Get In Touch!",
      description: "Ready to start purchasing your musical instruments on Musicon? That's great! Give us a call or send us an email and we will get back to you as soon as possible!"
    },
    {
      description: '123-456-7890',
      image: 'https://s3.amazonaws.com/codecademy-content/courses/learn-handlebars/musicon/phone+icon.svg',
      icon: 'phone icon'
    },
    {
      description: 'feedback@musicon.com',
      image: 'https://s3.amazonaws.com/codecademy-content/courses/learn-handlebars/musicon/mail+icon.svg',
      icon: 'email icon'
    },
    {
      location: ['Musicon', '111 Music Rd, Suite 33', 'New York, NY 11111'],
      image: 'https://s3.amazonaws.com/codecademy-content/courses/learn-handlebars/musicon/location+icon.svg',
